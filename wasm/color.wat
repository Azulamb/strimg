(module
 ...
 (global $wasm/color/L (mut f64) (f64.const 0))
 (global $wasm/color/a (mut f64) (f64.const 0))
 (global $wasm/color/b (mut f64) (f64.const 0))
 ...
 (export "distance" (func $wasm/color/distance))
 (export "getL" (func $wasm/color/getL))
 (export "getA" (func $wasm/color/getA))
 (export "getB" (func $wasm/color/getB))
 (export "rgbToLab" (func $wasm/color/rgbToLab))
 (export "ciede2000" (func $wasm/color/ciede2000))
 (export "radianToDegree" (func $wasm/color/radianToDegree))
 (export "degreeToRadian" (func $wasm/color/degreeToRadian))
 ...
 (func $wasm/color/calcColorVal (param $0 f64) (result f64)
  f64.const 0.04045
  local.get $0
  f64.lt
  if (result f64)
 ...
 (func $wasm/color/calcX (param $0 f64) (param $1 f64) (param $2 f64) (result f64)
  (local $3 f64)
  local.get $0
  f64.const 0.4124
  f64.mul
 ...
 (func $wasm/color/calcY (param $0 f64) (param $1 f64) (param $2 f64) (result f64)
  (local $3 f64)
  local.get $0
  f64.const 0.2126
  f64.mul
 ...
 (func $wasm/color/calcZ (param $0 f64) (param $1 f64) (param $2 f64) (result f64)
  (local $3 f64)
  local.get $0
  f64.const 0.0193
  f64.mul
 ...
 (func $wasm/color/rgbToLab (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 f64)
  (local $6 f64)
  ...
  local.get $4
  local.get $5
  call $wasm/color/calcX
  local.set $6
  local.get $3
  local.get $4
  local.get $5
  call $wasm/color/calcY
  local.set $7
  local.get $3
  local.get $4
  local.get $5
  call $wasm/color/calcZ
  local.set $8
  f64.const 116
  local.get $7
  f64.mul
  f64.const 16
  f64.sub
  global.set $wasm/color/L
  f64.const 500
  local.get $6
  local.get $7
  f64.sub
  f64.mul
  global.set $wasm/color/a
  f64.const 200
  local.get $7
  local.get $8
  f64.sub
  f64.mul
  global.set $wasm/color/b
 )
 (func $wasm/color/radianToDegree (param $0 f64) (result f64)
  local.get $0
  f64.const 180
 ...
 (func $wasm/color/calcHp (param $0 f64) (param $1 f64) (result f64)
  (local $2 f64)
  local.get $0
  f64.const 0
  f64.eq
  ...
  call $wasm/color/radianToDegree
  local.set $2
  local.get $2
  f64.const 0
  f64.lt
 ...
 (func $wasm/color/calcDelta (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result f64)
  local.get $0
  f64.const 0
  f64.eq
  if (result i32)
 ...
 (func $wasm/color/degreeToRadian (param $0 f64) (result f64)
  local.get $0
  global.get $~lib/bindings/Math/PI
  f64.const 180
  f64.div
 ...
 (func $wasm/color/calcHp2 (param $0 f64) (param $1 f64) (result f64)
  local.get $0
  local.get $1
  f64.sub
  call $~lib/bindings/Math/abs
 ...
 (func $wasm/color/calcSl (param $0 f64) (result f64)
  f64.const 1
  f64.const 0.015
  local.get $0
  f64.mul
 ...
 (func $wasm/color/calcRt (param $0 f64) (param $1 f64) (result f64)
  f64.const -2
  local.get $0
  local.get $0
  f64.const 25
  ...
  f64.mul
  call $wasm/color/degreeToRadian
  call $~lib/bindings/Math/sin
  f64.mul
 )
 (func $wasm/color/ciede2000 (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (param $4 f64) (param $5 f64) (param $6 f64) (param $7 f64) (param $8 f64) (result f64)
  (local $9 f64)
  (local $10 f64)
  (local $11 f64)
  (local $12 f64)
 ...
 (func $wasm/color/distance (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (result f64)
  (local $6 f64)
  (local $7 f64)
  (local $8 f64)
  (local $9 f64)
  ...
  local.get $1
  local.get $2
  call $wasm/color/rgbToLab
  global.get $wasm/color/L
  local.set $6
  global.get $wasm/color/a
  local.set $7
  global.get $wasm/color/b
  local.set $8
  local.get $3
  local.get $4
  local.get $5
  ...
  f64.const 1
  f64.const 1
  call $wasm/color/ciede2000
 )
 (func $wasm/color/getL (result f64)
  global.get $wasm/color/L
 )
 (func $wasm/color/getA (result f64)
  global.get $wasm/color/a
 )
 (func $wasm/color/getB (result f64)
  global.get $wasm/color/b
 )
